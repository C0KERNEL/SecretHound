...
```json
{
  "kinds": ["AWSSecret", "AWSBase", "StargateNetwork"],
  "properties": {
...
python fetch_nemesis_findings.py --api-key <Hasura GraphQL API key> > nemesis_export.json
